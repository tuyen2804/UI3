...
class AlbumAdapter(private val onClickFile: LibraryInterface) : RecyclerView.Adapter<AlbumAdapter.ViewHolder>() {
    private  var listItem : List<AlbumModel> = arrayListOf()
    ...
    fun setData(newData: List<AlbumModel>) {
        listItem = newData
