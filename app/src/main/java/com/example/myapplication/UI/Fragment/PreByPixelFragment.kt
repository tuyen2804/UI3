...
class PreByPixelFragment : Fragment() {

    private var _binding: FragmentPreByPixelBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPreByPixelBinding.inflate(inflater, container, false)
        return binding.root
    }
